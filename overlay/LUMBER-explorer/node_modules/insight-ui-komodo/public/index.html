...
<head>
  <base href="/" />
	...
	<title data-ng-if="currency.testnet" data-ng-bind="'LumberScout Explorer | ' + $root.title + $root.titleDetail + ' | Testnet Insight'">LumberScout Explorer</title>
	<title data-ng-if="!currency.testnet" data-ng-bind="'LumberScout Explorer | ' + $root.title + $root.titleDetail + ' | Insight'">LumberScout Explorer</title>
	<meta name="keywords" content="lumber, tally, lumberscout, komodo, transactions, blocks, address, block chain, best block, mining difficulty, hash serialized">
	<meta data-ng-if="currency.testnet" name="description" content="Lumber Insight. View detailed information on all testnet lumber transactions and block.">
	<meta data-ng-if="!currency.testnet" name="description" content="Lumber Insight. View detailed information on all Lumber transactions and block.">
	<link rel="shortcut icon" href="img/lumberscout-200x200.png">
