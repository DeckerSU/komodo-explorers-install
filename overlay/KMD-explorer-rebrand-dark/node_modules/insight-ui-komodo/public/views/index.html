...
<section data-ng-controller="IndexController" data-ng-init="index()">
  <div class="container">
	...
	<!--
        ...
        -->
        <p id="intro" translate>End-to-end Blockchain Solutions Provider empowering developers to build freely
and participate in creating the largest open blockchain network.</p>
        <p class="subIntro" translate><a href="https://komodoplatform.com" target="_blank" title="Komodo Platform">Komodo Platform</a> strives to accelerate the adoption of blockchain technologies around the globe and to lead the world in blockchain integration. All of the Komodo’s unique and cutting-edge technologies are open-source and available to everyone.</p>
        <p class="subIntro">With a collaborative approach, rather than a competitive one, Komodo Platform is working to unite the blockchain industry, empower business leaders and entrepreneurs, and eliminate the need for centralized third parties in financial transactions.</p>
