...
.block-id {
  background-color: #2c6f70 /*#373D42*/;
...
.block-tx {
  ...
  background-color: #1e2938 /*#F4F4F4*/;
  border-radius: 2px;
  margin: 20px 0 10px;
  overflow: hidden;
  padding: 15px;
  border: 1px solid #3b4c64 /*#eee*/;
...
.txvalues-primary {
  background-color: #36a8aa /*#41ead4;*/
}
...
.txvalues-success {
  background-color: #2b6680 /*#2FA4D7*/;
}

.txvalues-danger {
  background-color: #dc0333 /*#AC0015*/;
}
...
.progress-bar-info { background-color: #2c6f70; }
...
body {
  ...
  background-color: #1A2939; /* UI Dark 2 */
  font-family:'Rubik';line-height:1.6;/*font-size:16px;*/font-weight:400;
  background-image:url('../img/sub-header-logo-min.png');
  background-position: center center;
  background-repeat: no-repeat;
...
#powered a.komodoplatform{background-image:url('../img/komodoplatform.png');background-size:80px;width:100%}
.navbar-default .navbar-nav>li>a:hover { color: #283547 }
.navbar-default .navbar-nav>li>a:focus { color: #36a8aa }
#ngProgress { background-color: #41ead4 !important; }

/* .table-striped>tbody>tr:nth-child(odd)>td, .table-striped>tbody>tr:nth-child(odd)>th { background-color: rgba(0,0,0,0.1); } */

.table-striped>tbody>tr:nth-child(even)>td, .table-striped>tbody>tr:nth-child(even)>th { background-color: #233548; }
.table-striped>tbody>tr:nth-child(odd)>td, .table-striped>tbody>tr:nth-child(odd)>th { background-color: #364C65; }

.table>thead>tr>th, .table>tbody>tr>th, .table>tfoot>tr>th, .table>thead>tr>td, .table>tbody>tr>td, .table>tfoot>tr>td { }
.table>tbody>tr:not(:first-child)>td, .table>tfoot>tr:not(:first-child)>td { border-top-color: rgba(0,0,0,0.2); }
.table>tbody>tr>td, .table>tfoot>tr>td { border-top: 1px solid #3b4b63; }
.transaction-vin-vout { color: #41ead4; }
.ellipsis a { color: #36a8aa; }
.ellipsis .ng-scope { color: #36a8aa; }
.ellipsis small.ng-binding { color: #999; }
.ellipsis strong { color: #2b2c28; }
/* .ellipsis { color: #999; } */
.ellipsis { color: #fff; }
.secondary_navbar p.ng-binding { color: #999; }

.secondary_navbar h3 span.ng-scope { color: #2b2c28; } 
.secondary_navbar h3.ng-binding { color: #999; }
.secondary_navbar div.ng-binding { color: #999; } /* address */
.btn-info {
  background-color: #2b6680;
  border-color: #26456b;
  color: #fff;
...
.text-success { color: #2fea8b; }
.text-danger { color: #dc0333; }
.btn-expand:hover { color: #fff; }
.btn-default[disabled] { color: #333; }
.block-id h3 span.ng-scope {
    color: #fff;
}
.c3#chart  { color: #000; }
.c3#chart svg { fill: #fff; }
.v_highlight {
